...
"Copyright &copy; 2011-YYYY The FalCoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About FalCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>FalCoin</b> version", 0));
