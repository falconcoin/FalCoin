...
#define REWARD_CUT_BLOCK 3000001
...
// Launch specs
static const int64 nTargetTimespan = 3 * 120; // FalCoin: each block
static const int64 nTargetSpacing = 3 * 120; // FalCoin: 120 seconds
...
unsigned int static DarkGravityWave(const CBlockIndex* pindexLast, const CBlockHeader *pblock) {
    /* current difficulty formula, FalCoin - DarkGravity, written by Evan Duffield - evan@FalCoin.io */
    const CBlockIndex *BlockLastSolved = pindexLast;
    const CBlockIndex *BlockReading = pindexLast;
    const CBlockHeader *BlockCreating = pblock;
    BlockCreating = BlockCreating;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
      ...
      //vMerkleTree: 3f66108684400d84e2ffb528360d534fa19ecaf47c7c4c2ca1d1352ec4a351ad
        ...
        assert(block.hashMerkleRoot == uint256("0xc933b3c44f468f9c19da6b64eb21b947afc0f49dec53ce8d653a4c9c5deaa4bf"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xa6, 0xd2, 0xc3, 0xf6 }; // FalCoin: increase each by adding 2 to bitcoin's value.
